...
rriskModelClass$set("public", "add_author",
...
rriskModelClass$set("public", "change_author",
...
rriskModelClass$set("public", "remove_author",
...
rriskModelClass$set("public", "get_author",
  function(author_name = NULL, list_num = NULL, silent = FALSE) 
  {
    result <- private$check_author_input(author_name, list_num)
    if (!result$is_ok)
...
rriskModelClass$set("public", "get_author_list",
...
rriskModelClass$set("private", "check_add_author_input",
...
rriskModelClass$set("private", "check_change_author_input",
...
rriskModelClass$set("private", "check_author_input",
